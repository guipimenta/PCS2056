...
// VARIABLE ACTIONS
BOOL variable_hashtag(STATE current_state, STATE next_state, char current_char, char next_char, BOOL *endOfProgram);
...
BOOL lexic_error(STATE current_state, STATE next_state, char current_char, char next_char, BOOL *endOfProgram);
...
BOOL get_token(FILE *f, TOKEN *token_found, BOOL *wasTokenFound, BOOL *endOfProgram) {
